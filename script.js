...
document.querySelector('[data-add-query-param-btn]').addEventListener('click', () => {
    queryParamsContainer.append(createKeyValePair())
})

document.querySelector('[data-add-request-header-btn]').addEventListener('click', () => {
    requestHeadersContainer.append(createKeyValePair())
})
...
form.addEventListener('submit', e => {
    ...
    axios ({
        ...
        params: keyValePairsToObject(queryParamsContainer),
        headers: keyValePairsToObject(requestHeadersContainer),
        data,
    })
    .catch(e => e)
    .then(response => {
...
function keyValePairsToObject(container) {
